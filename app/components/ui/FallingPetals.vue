<template>
    <div class='pointer-events-none absolute inset-x-0 -top-6 bottom-0 overflow-visible' aria-hidden='true'>
        <AnimatePresence>
            <Motion
                v-for='petal in visiblePetals'
                :key='petal.id'
                as='span'
                :initial='{ y: -6, opacity: 0, rotate: petal.rotate }'
                :animate='{ y: 48, opacity: [0, 1, 1, 0], rotate: petal.rotate + 80 }'
